...
const HeroCards = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
            className="h-[250px] sm:h-[300px] md:flex-[2] rounded-2xl sm:rounded-3xl overflow-hidden relative group shadow-xl sm:shadow-2xl"
        variants={itemVariants}
        whileHover={{ scale: 1.02, y: -5 }}
        transition={{ type: "spring", stiffness: 400, damping: 10 }}
      >
        <Image
          src="/images/hero/dhaka-river.jpg"
        ...
        />
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 md:flex-[1]">
            {/* Travelogue Card */}
            <motion.div
              className="flex-1 h-[200px] sm:h-[180px] md:h-auto rounded-2xl sm:rounded-3xl overflow-hidden relative group shadow-xl sm:shadow-2xl"
              variants={itemVariants}
      ...
      <motion.div
            className="h-[200px] sm:h-[180px] md:flex-1 rounded-2xl sm:rounded-3xl overflow-hidden relative group shadow-xl sm:shadow-2xl"
        variants={itemVariants}
        whileHover={{ scale: 1.05, y: -5 }}
        transition={{ type: "spring", stiffness: 400, damping: 10 }}
      >
        <Image
          src="/images/hero/butterfly-featured.png"
