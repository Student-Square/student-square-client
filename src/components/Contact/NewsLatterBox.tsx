  ...
  return (
    <div className="shadow-three dark:bg-gray-dark relative z-10 rounded-xs bg-white p-8 sm:p-11 lg:p-8 xl:p-11">
      <h3 className="mb-4 text-2xl leading-tight font-bold text-black dark:text-white">
        Stay Connected with Student Square
      </h3>
      <p className="border-body-color/25 text-body-color mb-11 border-b pb-11 text-base leading-relaxed dark:border-white/25">
        Subscribe to our newsletter to receive updates about our latest initiatives, upcoming events, volunteer opportunities, and success stories from our community programs across Bangladesh.
      </p>
      <div>
        <input
          type="text"
